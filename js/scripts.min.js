...
$(document).ready(function () {
	$(".reserv_main_form").submit(function () { //Change
		var th = $(this);
		$.ajax({
			type: "POST",
			url: "mail.php", //Change
			...
			$('.reserv_main_form_success').toggleClass('reserv_main_form_success_active');
			setTimeout(function () {
				// Done Functions
				th.trigger("reset");
			}, 1000);
			setTimeout(function () {
				$('.reserv_main_form_success').removeClass('reserv_main_form_success_active');
			}, 2000)
		});
		return false;
	});
...
// video feedback 
$(document).ready(function () {
	var btn1 = $('.feedback_slider_icon_f1');
	var btn2 = $('.feedback_slider_icon_f2');
	var btn3 = $('.feedback_slider_icon_f3');
	// var btn4 = $('.feedback_slider_icon_f4');
	// var btn5 = $('.feedback_slider_icon_f5');
	// var btn6 = $('.feedback_slider_icon_f6');
	var btnrs = $('.information_video_icon_rs1');
	var overlay = $('.feedback_popup_overlay');

	overlay.on('click', function () {
		$('.feedback_popup').fadeOut(600);
		$('.feedback_popup_content_video').html(videoContent1).remove();
	})

	btnrs.on('click', function () {
		var videoContent1 = '<iframe width="560" height="315" src="https://www.youtube.com/embed/YqfbPbBTxEM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';

		$('.feedback_popup').fadeIn(600);
		$('.feedback_popup_content_video').html(videoContent1);
		$('.feedback_popup_overlay').fadeIn(600);
	})

	btn1.on('click', function () {
		var videoContent1 = '<iframe width="560" height="315" src="https://drive.google.com/file/d/1Z1T6WZ3mj2Z4Pezc-Vh6YTKG_EV7KyXk/preview" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
	...
	btn2.on('click', function () {
		var videoContent1 = '<iframe width="560" height="315" src="https://drive.google.com/file/d/1vfM6ApOoAlky7pqX9-DJjHm-azqT_H_r/preview" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
	...
	btn3.on('click', function () {
		var videoContent1 = '<iframe width="560" height="315" src="https://drive.google.com/file/d/1rhrIi8vQlMGnzzCqgd5F8VIK19XPo7r3/preview" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
